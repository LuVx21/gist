...
func getAllComicList() {
	url := "http://m.dolulu.com.cn/query/querycartoon/QueryCartoonListnolimit?apikey=gDvhBtIMa2Mxw7O33RVcSWc9FQVrEQqz"
	resp, _ := http.Get(url)
...
func getAllChaptersByComicId(comicId int32) []byte {
	url := "http://m.dolulu.com.cn/query/querycartoon/querychapterlistnolimit?apikey=gDvhBtIMa2Mxw7O33RVcSWc9FQVrEQqz&cartoon_id=%d"
...
func getAllChapterPhotos(comicId int32, kvs map[string]interface{}) {
	...
	url := "http://m.dolulu.com.cn/query/querycartoon/querychaptercontentnolimit?apikey=gDvhBtIMa2Mxw7O33RVcSWc9FQVrEQqz&cartoon_id=%d&chapter_id=%d"
